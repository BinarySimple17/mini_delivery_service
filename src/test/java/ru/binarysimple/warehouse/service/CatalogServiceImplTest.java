...
import ru.binarysimple.delivery.kafka.DeliveryCompensationResponseEvent;
import ru.binarysimple.delivery.kafka.DeliveryReservationResponseEvent;
import ru.binarysimple.delivery.mapper.CatalogMapper;
import ru.binarysimple.delivery.model.Catalog;
import ru.binarysimple.delivery.model.Product;
import ru.binarysimple.delivery.repository.CatalogRepository;
...
public class CatalogServiceImplTest {
    ...
    void reserveOrder_SuccessfulReservation_AllProductsAvailable() {
        ...
        // When
        DeliveryReservationResponseEvent response = catalogService.reserveOrder(order, sagaId);
    ...
    void compensateOrder_SuccessfulCompensation_AllProductsAvailable() {
        ...
        // When
        DeliveryCompensationResponseEvent response = catalogService.compensateOrder(order, sagaId);
